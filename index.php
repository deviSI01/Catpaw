...
<html><head>
    ...
    <base href="http://localhost/pakar_kucing/">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b><i class="fa fa-contao" aria-hidden="true"></i>at Paw Web Clinic</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Cat Paw Web Clinic</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <li class="user-body">
